"""Motor de autograd escalar (estilo micrograd) usado para el Deber 2."""
...
def cross_entropy_compact(o, y):
    """Binary cross-entropy entre la salida predicha `o` (Value) y la etiqueta real `y`."""
    yv = y if isinstance(y, Value) else Value(float(y), label='y')

    # forward numérico
    L = -(yv.data * math.log(o.data) + (1 - yv.data) * math.log(1 - o.data))

    out = Value(L, (o,), 'cross_entropy')  # solo depende de 'o' (salida del modelo)
